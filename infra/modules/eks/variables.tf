...
variable "cluster_admin_arns" {
  description = "List of additional IAM user/role ARNs to grant Kubernetes cluster-admin access via EKS access entries. Do not include the bootstrapped cluster creator."
  type        = list(string)
  default     = []
}
